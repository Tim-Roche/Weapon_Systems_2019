...
function [a_x, a_y, v_x, v_y, x_x, x_y, timeArray, timef, distancef, velf] = PM_withAirResistance_old(m, A, v_o, angle, deltaT, simRunTime)
...
for i = 2:totalPoints 
    ...
    k_x = (1/2)*CA_model_HW_2(mach_x)*density_x*A; 
    k_y = (1/2)*CA_model_HW_2(mach_y)*density_y*A;
